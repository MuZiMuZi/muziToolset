...
-   :material-broom:{ .lg .middle } **场景清理**
    ...
    [:octicons-code-24: Scene Clean API](../reference/tools/clean/hierarchy_cleaner.md)
...
[打开 Scene Clean API](../reference/tools/clean/hierarchy_cleaner.md){ .md-button .md-button--primary }
