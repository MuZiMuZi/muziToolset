...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_10.addWidget(self.fkCtrl_label)
        ...
        sizePolicy2.setHeightForWidth(self.ribbon_label.sizePolicy().hasHeightForWidth())
        self.ribbon_label.setSizePolicy(sizePolicy2)
