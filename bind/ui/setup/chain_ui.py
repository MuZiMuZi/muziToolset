...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy2.setHeightForWidth(self.module_edit.sizePolicy().hasHeightForWidth())
        self.module_edit.setSizePolicy(sizePolicy2)
        font3 = QFont()
        ...
        sizePolicy1.setHeightForWidth(self.index_label.sizePolicy().hasHeightForWidth())
        self.index_label.setSizePolicy(sizePolicy1)
        font5 = QFont()
        ...
        sizePolicy2.setHeightForWidth(self.index_edit.sizePolicy().hasHeightForWidth())
        self.index_edit.setSizePolicy(sizePolicy2)
        self.index_edit.setFont(font5)
        ...
        sizePolicy3.setHeightForWidth(self.jnt_number_sbox.sizePolicy().hasHeightForWidth())
        self.jnt_number_sbox.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.length_sbox.sizePolicy().hasHeightForWidth())
        self.length_sbox.setSizePolicy(sizePolicy3)
        ...
        sizePolicy1.setHeightForWidth(self.direction_cbox.sizePolicy().hasHeightForWidth())
        self.direction_cbox.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.jnt_parent_edit.sizePolicy().hasHeightForWidth())
        self.jnt_parent_edit.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.ctrl_parent_edit.sizePolicy().hasHeightForWidth())
        self.ctrl_parent_edit.setSizePolicy(sizePolicy2)
