...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_11.addWidget(self.index_label)
        ...
        self.horizontalLayout_11.addWidget(self.index_edit)
        ...
        self.jnt_number_sbox.setMinimum(4)
        ...
        self.ctrl_number_label = QLabel(self.centralwidget)
        self.ctrl_number_label.setObjectName(u"ctrl_number_label")
        sizePolicy.setHeightForWidth(self.ctrl_number_label.sizePolicy().hasHeightForWidth())
        self.ctrl_number_label.setSizePolicy(sizePolicy)
        self.ctrl_number_label.setFont(font3)

        self.horizontalLayout_9.addWidget(self.ctrl_number_label)

        self.ctrl_number_sbox = QSpinBox(self.centralwidget)
        self.ctrl_number_sbox.setObjectName(u"ctrl_number_sbox")
        sizePolicy.setHeightForWidth(self.ctrl_number_sbox.sizePolicy().hasHeightForWidth())
        self.ctrl_number_sbox.setSizePolicy(sizePolicy)
        self.ctrl_number_sbox.setFont(font3)
        self.ctrl_number_sbox.setMinimum(2)
        self.ctrl_number_sbox.setValue(3)

        self.horizontalLayout_9.addWidget(self.ctrl_number_sbox)
        ...
        sizePolicy.setHeightForWidth(self.curve_label.sizePolicy().hasHeightForWidth())
        self.curve_label.setSizePolicy(sizePolicy)
        self.curve_label.setFont(font3)

        self.horizontalLayout_8.addWidget(self.curve_label)

        self.curve_Edit = QLineEdit(self.centralwidget)
        self.curve_Edit.setObjectName(u"curve_Edit")
        self.curve_Edit.setEnabled(False)
        sizePolicy.setHeightForWidth(self.curve_Edit.sizePolicy().hasHeightForWidth())
        self.curve_Edit.setSizePolicy(sizePolicy)
        self.curve_Edit.setFont(font3)

        self.horizontalLayout_8.addWidget(self.curve_Edit)

        self.curve_btn = QPushButton(self.centralwidget)
        self.curve_btn.setObjectName(u"curve_btn")
        sizePolicy.setHeightForWidth(self.curve_btn.sizePolicy().hasHeightForWidth())
        self.curve_btn.setSizePolicy(sizePolicy)
        self.curve_btn.setFont(font3)

        self.horizontalLayout_8.addWidget(self.curve_btn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ctrl_number_label.setText(QCoreApplication.translate("MainWindow", u"ctrl_number:", None))
        self.curve_label.setText(QCoreApplication.translate("MainWindow", u"curve:", None))
        self.curve_btn.setText(QCoreApplication.translate("MainWindow", u"select", None))
