...
def create_config_attr_name(
    ...
    u"""使用 RigBase 创建不带序号的 Config Attribute 名称。"""
    node_name = RigBase.create_name(
        type=type,
        side=side,
        part=part,
        function=function,
...
face_master_grp = RigBase.create_name(
    type="grp",
    side=face_side,
    part=face_part,
    function="master",
...
face_guide_grp = RigBase.create_name(
    type="grp",
    side=face_side,
    part=face_part,
    function="guide",
...
face_ctrl_grp = RigBase.create_name(
    type="grp",
    side=face_side,
    part=face_part,
    function="ctrl",
...
face_jnt_grp = RigBase.create_name(
    type="grp",
    side=face_side,
    part=face_part,
    function="jnt",
...
face_rig_nodes_grp = RigBase.create_name(
    type="grp",
    side=face_side,
    part="face_rig",
    function="nodes",
...
face_pos_driver_grp = RigBase.create_name(
    type="grp",
    side=face_side,
    part="face_pos",
    function="driver",
...
face_model_grp = RigBase.create_name(
    type="grp",
    side=face_side,
    part=face_part,
    function="model",
...
face_tweak_grp = RigBase.create_name(
    type="grp",
    side=face_side,
    part=face_part,
    function="tweak",
...
face_stretch_grp = RigBase.create_name(
    type="grp",
    side=face_side,
    part=face_part,
    function="stretch",
...
face_deform_grp = RigBase.create_name(
    type="grp",
    side=face_side,
    part=face_part,
    function="deform",
...
face_ctrl_set = RigBase.create_name(
    type="set",
    side=face_side,
    part=face_part,
    function="ctrl",
...
config_node = RigBase.create_name(
    type="network",
    side=face_side,
    part=face_part,
    function="config",
...
face_guide_move_ctrl = RigBase.create_name(
    type="ctrl",
    side=face_side,
    part=face_part,
    function="move",
