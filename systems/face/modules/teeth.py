...
class TeethModule(FaceModuleBase):
    ...
    def create_finalize(self):
        ...
        #将对应的控制器和关节都放到对应的组下
        hierarchy_utils.parent(child_node = self.lower_teeth_jnt,parent_node =teeth_jnt_grp)
        hierarchy_utils.parent(child_node =self.upper_teeth_jnt,parent_node =teeth_jnt_grp)
