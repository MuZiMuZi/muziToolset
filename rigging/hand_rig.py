...
class Hand_Rig(arm_rig.Arm_Rig):
    ...
    def create_hand_rig(self):
        ...
        fk_chains = [thumbHand_fk_chain,indexHand_fk_chain,middleHand_fk_chain,ringHand_fk_chain ,pinkyHand_fk_chain]
        for fk_chain in fk_chains:
            self.fk_chain_rig(fk_chain,control_parent = hand_ctrl_grp)
            cmds.setAttr(fk_chain[0] + '.visibility',1)
        fk_chains_mirror = [ thumbHand_fk_chain_mirror,  indexHand_fk_chain_mirror,middleHand_fk_chain_mirror, ringHand_fk_chain_mirror,
