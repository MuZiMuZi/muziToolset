...
################################################################################
## Form generated from reading UI file 'bind.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionMirror_select = QAction(MainWindow)
        self.actionMirror_select.setObjectName(u"actionMirror_select")
        self.actionMirror = QAction(MainWindow)
        self.actionMirror.setObjectName(u"actionMirror")
        self.actionUpward = QAction(MainWindow)
        self.actionUpward.setObjectName(u"actionUpward")
        self.actionLowward = QAction(MainWindow)
        self.actionLowward.setObjectName(u"actionLowward")
        ...
        self.menuCustom.addAction(self.actionMirror_select)
        self.menuCustom.addAction(self.actionMirror)
        self.menuCustom.addSeparator()
        self.menuCustom.addAction(self.actionUpward)
        self.menuCustom.addAction(self.actionLowward)
        self.menuCustom.addAction(self.actionDelete)
        self.menuCustom.addSeparator()
        self.menuCustom.addAction(self.actionRename)
        self.menuCustom.addAction(self.actionClear)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionMirror_select.setText(QCoreApplication.translate("MainWindow", u"Mirror_selection", None))
        self.actionMirror.setText(QCoreApplication.translate("MainWindow", u"Mirror_All", None))
        self.actionUpward.setText(QCoreApplication.translate("MainWindow", u"Upward", None))
        self.actionLowward.setText(QCoreApplication.translate("MainWindow", u"Downward", None))
