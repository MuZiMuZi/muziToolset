...
class Constraint_Tool (QWidget) :
    ...
    def create_widgets (self) :
        ...
        self.scale_constraint_btn = QPushButton ('缩放约束')
        self.aim_constraint_btn = QPushButton ('目标约束')
        self.pole_vector_constraint_btn = QPushButton ('极向量约束')
        self.select_constraint_btn = QPushButton ('选择约束')
        self.delete_constraint_btn = QPushButton ('删除约束')
